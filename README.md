...
Features
	...
	•	Record Management: Easily store, view, and update health records.
	•	Data Security: Ensures the protection of sensitive information using Firebase and modern encryption practices.
	•	Responsive Design: Optimized for both desktop and mobile users.
	•	Intuitive Interface: Simple navigation and user-friendly design for a seamless experience.
...
git clone https://github.com/samgus/health-records.git
